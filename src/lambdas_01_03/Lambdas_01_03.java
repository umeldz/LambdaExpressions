...
public class Lambdas_01_03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("expected value 4, actual value :"
				  + intToString.apply(4567).length());
		
		//Lambdas made using constructor
		Function<String,BigInteger> newBigInteger = BigInteger::new;
		System.out.println("expected value 123456789, actual value :"
				  + newBigInteger.apply("123456789"));
		...
		System.out.print(makeGreeting.apply("Peggy"));
